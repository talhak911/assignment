...
let array2:number []= [2,3,4,6,5,9,10];
...
let array11:number []= [8,2,3,4,6,5,9,10];
...
let radius:number=5;
function areaOfCircle(n:number){
    let area:number= pi*(n*n);
...
let grades: number[]=[20,30,50,60,70,40];
...
let array12:number[]=[100,12,13,12,102];

function largestE(arr:number[]){
    let largestEle:number=0;
...
console.log("Largest element is ",largestE(array12));
